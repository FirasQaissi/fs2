...
export default function UserProfile() {
  ...
  const handleEditSave = async () => {
    ...
    try {
      ...
      setSnack({ open: true, message: error.message || 'Failed to update profile', severity: 'error' });
    }
  };
  ...
  const handlePasswordChange = async () => {
    ...
    try {
      ...
      setSnack({ open: true, message: error.message || 'Failed to change password', severity: 'error' });
    }
  };
